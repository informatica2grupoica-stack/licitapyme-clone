// Genera el ANEXO N°4 (oferta económica) de 1426039-8-LE26 REAL, con generarAnexoFinal, para
// verificar el arreglo de pideRut (leyenda "Nombre, RUT y Firma Representante Legal").
// Uso: npx tsx scripts/_generar-1426039-8-le26.mts
...
const EMPRESA_ID = 2;
const URL_ORIGINAL = 'https://pub-722f3e1c29d74bcb8ee49776fe8a2c0d.r2.dev/1426039-8-LE26/1786052733419_ANEXO_N__4.docx';
const OUT_PATH = 'C:/Users/droku/AppData/Local/Temp/claude/D--licitapyme-clone/aa86d70f-a793-492f-9f25-44997cf92b81/scratchpad/ANEXO_N4_1426039_FIX.docx';
...
console.log(`empresa=${empresa.razon_social} representante=${empresa.representante_nombre} rut=${empresa.representante_rut}`);
