...
const [rows] = await pool.query(`SHOW COLUMNS FROM documentos_cache LIKE 'categoria_manual'`) as any[];
console.log('columna categoria_manual existe:', (rows as any[]).length > 0);
await pool.end();
