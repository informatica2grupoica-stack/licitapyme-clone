// Aplica migration-108: columnas de datos bancarios (solo lectura desde Obuma) en compras_proveedor.
// Uso: node scripts/aplicar-migration-108.mjs
...
const COLUMNAS = [
  ['obuma_tiene_cuenta_bancaria', 'TINYINT(1) NULL'],
  ['obuma_numero_cuenta', 'VARCHAR(60) NULL'],
  ['obuma_tipo_cuenta', 'VARCHAR(60) NULL'],
  ['obuma_forma_pago', 'VARCHAR(150) NULL'],
];

try {
  console.log('\n  Aplicando migration-108 (datos bancarios de Obuma en compras_proveedor)...');
